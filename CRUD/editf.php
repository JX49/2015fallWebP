    ...
    <div class="container">
        ...
        <form class="form-horizontal" name="form1" action="" method="post" >
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
                  <input type="text" class="form-control" id="txtCalories" name="Calories" placeholder="Calories"  value="<?=$meal['Calories']?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="txtDate">Meal time</label>
            <div class="col-sm-10">
                  <select class="form-control date" id="txtDate" name="Time" placeholder="Date"  value="<?=$meal['Time']?>">
         ...
         $("#submit").on('click', function(e){
          ...
          toastr.error("Name must be filled out");
            ...
            return false;
                ...
                e.preventDefault();
                toastr.error("Calories must be a number!");
                 return false;
             }
